...
var Mouse = function () {
    ...
    */
    this.eventMap = {
      mouseleave: {
        ...
        listeners: [{ name: "mouseenter", method: this._mouseEnter }, { name: "touchenter", method: this._touchEnter }],
        added: false
      },
      mouseenter: {
        events: [this.leaveEvents],
        listeners: [{ name: "mouseleave", method: this._mouseLeave }, { name: "touchleave", method: this._touchLeave }, { name: "touchcancel", method: this._touchCancel }],
        added: false
      },
      mousedown: {
  ...
  _createClass(Mouse, [{
    ...
    key: "_mouseLeave",
    value: function _mouseLeave(event) {
      var isTouching = this.isTouching,
          preventDefault = this.preventDefault;
    ...
    key: "onEnter",
    value: function onEnter(enterEvent) {
    ...
    key: "removeEnter",
    value: function removeEnter(enterEvent) {
    ...
    key: "onLeave",
    value: function onLeave(leaveEvent) {
    ...
    key: "removeLeave",
    value: function removeLeave(leaveEvent) {
    ...
    key: "onDown",
    value: function onDown(downEvent) {
    ...
    key: "removeDown",
    value: function removeDown(downEvent) {
    ...
    key: "removeUp",
    value: function removeUp(upEvent) {
    ...
    key: "onMove",
    value: function onMove(moveEvent) {
    ...
    key: "removeMove",
    value: function removeMove(moveEvent) {
